...
public class ReferenciaConvert {
    ...
    public static Referencia referenciaFormToPublicacaoEntity(ReferenciaFormDTO referenciaForm){
        return Referencia.builder().texto(referenciaForm.getTexto())
                                // .publicacao(referenciaForm.getPublicacao())
                                .build();
    }
}
